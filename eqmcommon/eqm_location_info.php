        ...
        <section class="content">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-success">
                        <div class="box-header with-border">
                            <h3 class="box-title">สถานที่ใช้งานครุภัณฑ์</h3>
					  ...
					  <table id="example1" class="table table-bordered table-striped">
						<thead>
							<tr>
								...
								<th class="text-center">สถานที่ใช้งานครุภัณฑ์</th>
				...
				<?php	
						...
						$cmd  = "SELECT  lc.no, lc.name, st.no as stno ";
						$cmd .= "FROM  ".getdbname("eqm_location","lc")." ";
						$cmd .= "left join ".getdbname("status","st")." on st.id = lc.status ";
						$cmd .= "where lc.DelBy is null";
